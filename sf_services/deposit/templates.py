...
<body style="background-color: #f2f2f2;">
    <main class="">
        ...
        <div class="announce_box offset">
            ...
            <div class="offset" style="display: flex; justify-content: space-between; width: 83.3%;">
                <div style="width: 33.32%;"><img src="@@image1@@"
                        style="height: 170px; width: 170px; display: block; border-radius: 4px;" alt="image 1">
                </div>
                <div style="width: 33.32%;"><img src="@@image2@@"
                        style="height: 170px; width: 170px; display: block; border-radius: 4px;" alt="image 2">
                </div>
                <div style="width: 33.32%;"><img src="@@image3@@"
                        style="height: 170px; width: 170px; display: block; border-radius: 4px;" alt="image 3">
                </div>
            </div>
        </div>
        ...
        <div class="offset">
            <p class="email-paragraph">Quelques astuces pour @@search_type@@ vite et bien !</p>
            ...
            <p style="font-size: 16px; font-weight: bold;">A votre service, l'équipe Surfyn</p>
        </div>
    ...
    <main class="">
        <div class="morning_box offset">
            <div class="morning_box_hello">
                ...
                <p class="hello_phrase">Bonjour @@display_name@@,</p>
                <p class="hello_message">
                    Votre annonce a bien été supprimé de <a href="https://surfyn.fr"
