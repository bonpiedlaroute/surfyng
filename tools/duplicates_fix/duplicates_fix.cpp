...
void readTable(const std::shared_ptr<dynamodb_accessClient>& client, const std::string& tableName, std::vector<classifier::RealEstateAd*>& announcesID)
{
   ...
   do
   {
      ...
      fillFilterExprAndExprValue(filterExpression, expressionValue, "CITY", exprval_city, "puteaux", "=");
      filterExpression << " and ";
      filterExpression << "PROPERTY_TYPE";
      filterExpression << " in (";
      std::string expr = ":pyMaison";
      filterExpression << expr;
      filterExpression << ")";

      ValueType exprValue;
      exprValue.field = "Maison";
...
int main(int argc, char* argv[])
{
   ...
   surfyn::readTable(client, tablename, announces);
