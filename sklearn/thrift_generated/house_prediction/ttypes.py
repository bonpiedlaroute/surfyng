...
class PredictionResult(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.DOUBLE, 'predictedvalue', None, None, ),  # 1
        (2, TType.STRING, 'error', 'UTF8', None, ),  # 2
    )

    def __init__(self, predictedvalue=None, error=None,):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.DOUBLE:
                    self.predictedvalue = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.predictedvalue is not None:
            oprot.writeFieldBegin('predictedvalue', TType.DOUBLE, 1)
            oprot.writeDouble(self.predictedvalue)
            oprot.writeFieldEnd()
